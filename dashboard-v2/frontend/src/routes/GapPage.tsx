...
export function GapPage() {
  ...
  function onSort(value: SortingState) {
      ...
      <div className="mb-6 flex flex-wrap items-end justify-between gap-4">
        ...
        <div>
          ...
          <p className="mt-1 text-slate-500">
            Latest Daraz prices compared with local competitors.
          </p>
        ...
        <div className="text-right text-xs text-slate-500">
          ...
          <strong>
            {gaps.data?.meta?.dataAsOf ?? '—'}
          </strong>


          {
            gaps.data?.meta?.stale &&
            <span className="ml-2 rounded bg-amber-100 px-2 py-1 font-bold text-amber-700">
              Stale data
            </span>
          }
        ...
        >
          ...
          <div className="flex items-center gap-3">
            ...
            <span>
              Page
              {' '}
              {gaps.data?.pagination?.page ?? 1}
              {' '}
              of
              {' '}
              {gaps.data?.pagination?.totalPages ?? 1}
            </span>
